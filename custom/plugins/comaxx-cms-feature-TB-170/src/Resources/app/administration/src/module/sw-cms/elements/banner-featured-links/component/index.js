import template from './sw-cms-el-banner-featured-links.html.twig';
import './sw-cms-el-banner-featured-links.scss';

Shopware.Component.register('sw-cms-el-banner-featured-links', {
    template,
    ...
    computed: {
        ...
        bannerBackgroundColor() {
            let bannerBackgroundColor = this.element.config.bannerBackgroundColor.value;
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('banner-featured-links');
        },
    },
});
